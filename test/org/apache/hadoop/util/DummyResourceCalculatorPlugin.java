...
public static final String  MAXTEMP_TESTING_PROPERTY = 
      "mapred.tasktracker.cputemp.testing";

 public static final String  MAXDTEMP_TESTING_PROPERTY = 
		"mapred.tasktracker.disktemp.testing";

  public static final String  MAXDUSAGE_TESTING_PROPERTY = 
		 "mapred.tasktracker.diskusage.testing";
...
/** {@inheritDoc} */
 ...
 public int getCpuTemp() {
    return getConf().geInt(MAXTEMP_TESTING_PROPERTY, -1);
  }

  /** {@inheritDoc} */
	@Override
   public int getDiskTemp() {
	  return getConf().geInt(MAXDTEMP_TESTING_PROPERTY, -1);
	}

  /** {@inheritDoc} */
	@Override
   public float getDiskUsage() {
	  return getConf().geFloat(MAXDUSAGE_TESTING_PROPERTY, -1);
	}
