...
public class ClusterStatus implements Writable {
  ...
  public static Map<String,Integer> tempmap = new HashMap<String,Integer>();
  public static Map<String,Integer> dtempmap = new HashMap<String,Integer>();
  public static Map<String,Float> dusagemap= new HashMap<String,Float>();
   public static Map<String,Float> cpuusagemap = new HashMap<String,Float>(); 

   /*static_scheduler*/
   public static Map<String,Float> avgcpusage = new HashMap<String,Float>();  
//   public static Map<String,Integer> cprise = new HashMap<String,Integer>();  
//   public static Map<String,Integer> drise = new HashMap<String,Integer>();  
   public static Map<String,Float> avgdusage = new HashMap<String,Float>();  
   
//   public static Map<String,Float> cpuusagemap = new HashMap<String,Float>();  
   

 
  private Log log = LogFactory.getLog(ClusterStatus.class);
  ...
  ClusterStatus(int trackers, int maps, int reduces, int maxMaps,
	...
	log.info("Constructor ClusterStatus-3 "+trackers+" "+maxMaps+" "+maxReduces+" "+maps+" "+reduces);
  }
  ...
  ClusterStatus(int trackers, int blacklists, int graylists,
    ...
    this(trackers, blacklists, graylists, ttExpiryInterval, maps, reduces,
	    ...
	    log.info("Constructor ClusterStatus-2 "+trackers+" "+maxMaps+" "+maxReduces+" "+maps+" "+reduces);
  }
  ...
  ClusterStatus(int trackers, int blacklists, int graylists,
    ...
    this(trackers, blacklists, graylists, ttExpiryInterval, maps, reduces, 
	    ...
	    log.info("Constructor ClusterStatus-1 "+trackers+" "+maxMaps+" "+maxReduces+" "+maps+" "+reduces);
  }
  ...
  ClusterStatus(Collection<String> activeTrackers,
    ...
    this(activeTrackers, blacklistedTrackers, graylistedTrackers,
	    ...
	    log.info("Constructor ClusterStatus0 "+maxMaps+" "+maxReduces+" "+maps+" "+reduces);
  }
  ...
  ClusterStatus(int trackers, int blacklists, int graylists,
    ...
    this.max_memory = max_memory;
					log.info("Constructor ClusterStatus1 "+trackers+" "+maxMaps+" "+maxReduces+" "+maps+" "+reduces);
  }
  ...
  ClusterStatus(Collection<String> activeTrackers, 
    ...
    this.graylistedTrackers = graylistedTrackers;
	    ...
	    log.info("Constructor ClusterStatus2 "+maxMaps+" "+maxReduces+" "+maps+" "+reduces);
  }
